...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const elements = {
        ...
        tickerInitial: document.getElementById('ticker-initial'),
        currentPrice: document.getElementById('current-price'),
        priceChange: document.getElementById('price-change'),
        priceChangeContainer: document.getElementById('price-change-container'),
        priceChangeIcon: document.getElementById('price-change-icon'),
        companySector: document.getElementById('company-sector'),
        companyIndustry: document.getElementById('company-industry'),
        companyDesc: document.getElementById('company-description'),
        marketCap: document.getElementById('market-cap'),
        volume: document.getElementById('volume'),
        wHigh52: document.getElementById('52w-high'),
        wLow52: document.getElementById('52w-low'),
        newsContainer: document.getElementById('news-container'),
        popularStocks: document.getElementById('popular-stocks-list'),
        loadingOverlay: document.getElementById('loading-overlay'),
        errorMsg: document.getElementById('error-message'),
        errorText: document.getElementById('error-text'),
        trendText: document.getElementById('market-trend-text'),
        trendIcon: document.getElementById('market-trend-icon'),
        trendIconBox: document.getElementById('market-trend-icon-container'),
        recBadge: document.getElementById('recommendation-badge'),
        targetPrice: document.getElementById('target-forecast-price'),
        confPercent: document.getElementById('confidence-percent'),
        confBar: document.getElementById('confidence-bar'),
        volatility: document.getElementById('volatility-level'),
        rsiSent: document.getElementById('rsi-sentiment'),
        ...
        liveFeedBadge: document.getElementById('live-feed-badge')
    };
